    ...
    <q-layout view="hHh lpR fFf">
      ...
      <q-header elevated class="bg-morado text-white">
        <q-toolbar class="q-gutter-x-sm">
          <q-toolbar-title>
            <q-icon class="q-ml-xs q-mr-md" name="fas fa-clock" color="white" />
            {{ contador }}
          </q-toolbar-title>
          <q-btn flat rounded color="white" icon="fas fa-comments" @click="onClick" />
          <q-separator vertical inset color="white" />
          <q-btn flat rounded color="white" :icon="!video ? 'fas fa-video' : 'fas fa-video-slash'"
            @click="video = !video" disable />
          <q-btn flat rounded color="white" :icon="!silenciado ? 'fas fa-microphone' : 'fas fa-microphone-slash'"
            @click="alternarMicro" />
          <q-btn color="negative" icon="fas fa-phone-slash" label="Salir" @click="abandonar" />
        </q-toolbar>
      </q-header>
